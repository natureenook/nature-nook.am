        ...
        <div className="bg-[#f5f1e6] text-[#2d2d2d]">
            ...
            <section className="min-h-screen flex flex-col items-center justify-center text-center px-6">
                <h1 className="text-4xl md:text-6xl font-bold mb-6">
                    Շների խնամք՝ պարզ, ճիշտ, առանց սխալների
                </h1>
                <p className="text-lg md:text-xl text-[#555] mb-8 max-w-2xl">
                    Սովորիր պահել առողջ և երջանիկ շուն՝ առանց ավելորդ գլխացավի
                </p>
            ...
            <section className="py-16 px-6 max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
                <div className="p-6 bg-white rounded-2xl shadow">
                    ...
                    <p className="text-[#555]">
                        Ինչպես ճիշտ սնուցել և խնամել շունը սկզբից
                    </p>
                </div>
                ...
                <div className="p-6 bg-white rounded-2xl shadow">
                    ...
                    <p className="text-[#555]">
                        Սնունդ, վարժանք, հիգիենա՝ ամենակարևոր քայլերը
                    </p>
                </div>
                ...
                <div className="p-6 bg-white rounded-2xl shadow">
                    ...
                    <p className="text-[#555]">
                        Հիվանդություն, վարք, մազափոշի — արագ լուծումներ
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 bg-[#ebe3d3] text-center px-6">
                ...
                <div className="max-w-3xl mx-auto space-y-4 text-[#444]">
                    ...
                    <p>✔️ Խնայող լուծումներ՝ առանց ավելորդ ծախսերի</p>
                </div>
            </section>
                ...
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center px-4">
                    <div className="bg-white rounded-2xl p-8 max-w-lg w-full text-left">
                        ...
                        <p className="text-[#555] mb-6">
                            Այս ուղեցույցով դու կսովորես՝ ինչպես ճիշտ կերակրել, վարժեցնել և խնամել շունդ՝ առողջ ու երջանիկ պահելու համար։
                        </p>
                        <button
