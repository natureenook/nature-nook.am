    ...
    <div className="bg-[#f5f1e6] text-[#2d2d2d]">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Թռչունների խնամք՝ ճիշտ և անվտանգ
        </h1>
        <p className="text-lg md:text-xl text-[#555] mb-8 max-w-2xl">
          Պահիր առողջ ու ակտիվ թռչուններ՝ առանց սխալ սննդի և խնամքի
        </p>
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        <div className="p-6 bg-white rounded-2xl shadow">
          ...
          <p className="text-[#555]">
            Ինչպես ընտրել ճիշտ թռչուն և վանդակ
          </p>
        </div>
        ...
        <div className="p-6 bg-white rounded-2xl shadow">
          ...
          <p className="text-[#555]">
            Սնունդ, ջուր, մաքրություն՝ ճիշտ բալանս
          </p>
        </div>
        ...
        <div className="p-6 bg-white rounded-2xl shadow">
          ...
          <p className="text-[#555]">
            Չի երգում? Թույլ է? Արագ լուծումներ
          </p>
        </div>
      </section>
      ...
      <section className="py-20 text-center px-6">
        <h2 className="text-3xl font-bold mb-6">
          Սկսիր ճիշտ խնամել թռչուններին այսօր
        </h2>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center px-4">
          <div className="bg-white rounded-2xl p-8 max-w-lg w-full">
            ...
            <p className="text-[#555] mb-6">
              Կսովորես՝ ինչպես ճիշտ կերակրել, խնամել և պահել թռչուններին՝ առանց առողջական խնդիրների։
            </p>
